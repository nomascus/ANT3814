...
> CLick on the Console button in the bottom left window and enter the following text but CHANGE orkin to your userID
...
# Load the dataset ANT3814_ps.rds into R studio.
...
# QUESTION 11: In the pairwise PERMANOVA test, we are looking to see which (if any) pairs of body sites have significantly different microbial communities. Looking at the adjusted p-value column (p.adj) in p.table, the microbiome communities of which body sites are a significant different from eachother? 
