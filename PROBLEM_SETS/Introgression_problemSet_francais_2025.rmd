...
# Remplacez USERID par votre identifiant utilisateur dans la commande suivante, puis copiez-le et collez-le dans la console ci-dessous, puis cliquez sur Entrée :
